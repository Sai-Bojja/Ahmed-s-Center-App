...
const Receipt = forwardRef(({ cart, total }, ref) => {
    ...
    return (
        <div ref={ref} style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 0.5fr 1fr', gap: '2px', fontWeight: 'bold', margin: '5px 0' }}>
                <span>Item</span>
            ...
            <div style={{ borderTop: '1px dashed #000', padding: '10px 0', marginTop: '10px' }}>
